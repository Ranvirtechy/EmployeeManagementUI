var PeakAuth = function (service, redirectUri) {
    ...
    self.api = {
        ...
        services: function (by) { return self.get("api/services" + (by ? "?by=" + by : "")).fail(self.manager.reauth); },
        userServices: {
            get: function (serviceId) { return self.get("api/userservices/" + (serviceId || "")).fail(self.manager.reauth); },
            post: function (userServiceModel) { return self.post("api/userservices",userServiceModel).fail(self.manager.reauth) }
        }
    };
